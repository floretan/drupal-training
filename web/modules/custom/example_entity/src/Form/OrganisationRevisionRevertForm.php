 ...
 */
class OrganisationRevisionRevertForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new OrganisationRevisionRevertForm.
   *
  ...
  public function getFormId() {
    return 'organisation_revision_revert_confirm';
  }
   ...
   *
   * @param \Drupal\example_entity\Entity\OrganisationInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\example_entity\Entity\OrganisationInterface
